...
namespace ADService.Foundation
{
    ...
    public class LDAPDomainDNS : LDAPAssembly
    {
        ...
        internal LDAPDomainDNS(in DirectoryEntry entry, in LDAPEntriesMedia entriesMedia, in ResultPropertyCollection propertiesResult) : base(entry, CategoryTypes.DOMAIN_DNS, entriesMedia, propertiesResult) {}
    }
}