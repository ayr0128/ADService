...
namespace ADService.Foundation
{
    ...
    public class LDAPContainer : LDAPAssembly
    {
        ...
        internal LDAPContainer(in DirectoryEntry entry, in LDAPEntriesMedia entriesMedia, in ResultPropertyCollection propertiesResult) : base(entry, CategoryTypes.CONTAINER, entriesMedia, propertiesResult) { }
    }
}
