...
namespace ADService.Foundation
{
    ...
    public class LDAPOrganizationUnit : LDAPAssembly
    {
        ...
        internal LDAPOrganizationUnit(in DirectoryEntry entry, in LDAPEntriesMedia entriesMedia, in ResultPropertyCollection propertiesResult) : base(entry, CategoryTypes.ORGANIZATION_UNIT, entriesMedia, propertiesResult) { }
    }
}