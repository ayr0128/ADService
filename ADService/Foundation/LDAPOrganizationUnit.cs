...
namespace ADService.Foundation
{
    ...
    public class LDAPOrganizationUnit : LDAPAssembly
    {
        ...
        internal LDAPOrganizationUnit(in DirectoryEntry entry, in LDAPConfigurationDispatcher dispatcher, in ResultPropertyCollection propertiesResult) : base(entry, CategoryTypes.ORGANIZATION_UNIT, dispatcher, propertiesResult) { }
    }
}